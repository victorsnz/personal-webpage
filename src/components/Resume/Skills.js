        ...
        <h3>Programming Languages & Tools</h3>
          <Row>
            <Col id={"tec-list"} md={12}>
              <ul>
                <li><img src={HTML5} alt="HTML5 logo" title={"HTML 5"}/></li>
                <li><img src={CSS3} alt="CSS3 logo" title={"CSS 3"}/></li>
                <li><img src={Bootstrap} alt="Bootstrap logo" title={"Bootstrap"}/></li>
                <li><img src={JS} alt="Javascript logo" title={"Javascript"}/></li>
                <li><img src={ReactJS} alt="React logo" title={"React"}/></li>
                <li><img src={NodeJS} alt="NodeJS logo" title={"NodeJS"}/></li>                                
                <li><img src={Postman} alt="Postman logo" title={"Postman"}/></li>                
                <li><img src={MongoDB} alt="MongoDB logo" title={"MongoDB"}/></li>                
                <li><img src={Firebase} alt="Firebase logo" title={"Firebase"}/></li>                                
                <li><img src={MySQL} alt="MySQL logo" title={"MySQL"}/></li>       
                <li><img src={Csharp} alt="C Sharp logo" title={"C#"}/></li>
                <li><img src={DotNetCore} alt="Dot Net Core logo" title={".NET CORE"}/></li>
                <li><img src={Linux} alt="Linux logo" title={"Linux"}/></li>
                <li><img src={Git} alt="Git logo" title={"GIT"}/></li>                
                <li><img src={Photoshop} alt="Adobe Photoshop logo" title={"Adobe Photoshop CS6"}/></li>
                <li><img src={XD} alt="Adobe XD logo" title={"Adobe Xd"}/></li>
              </ul>
            </Col>
          </Row>
        <br/>
